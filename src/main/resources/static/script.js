...
//            .then(data => {
//             let totalDoctors = data.length > 0 ? data.length : 0 ;
//             document.getElementById("total-doctor-box").innerText = totalDoctors;
//             displayDoctors(data);
//            })
//            }
...
//        fetch(`${API_BASE_URL}/patients/all`) // Use the correct API endpoint
//            .then(response => response.json())
//            .then(
//            data => {
...
if (document.body.id === 'admin-dashboard-page') {
    ...
    function displayPatients(patients) {
        ...
        document.getElementById("total-patient-box").innerText = totalPatients;
    }
    ...
    function displayAppointments(appointments) {
        ...
        document.getElementById("total-appointments-box").innerText = totalAppointments;
    }
